...
BLOB_SERVICE_NAME = "AzureBlobStorage"
...
def run_example():
    ...
    operation_config = {}
    request = service_client.put("/subscriptions/" + SUBSCRIPTION_ID + "/resourceGroups/" + RESOURCE_GROUP + "/providers/Microsoft.Storage/storageAccounts/" + STORAGE_ACCOUNT_NAME + "/blobServices/" + BLOB_SERVICE_NAME + "/containers/" + CONTAINER_NAME, query_parameters)
