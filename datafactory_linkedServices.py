...
LINKEDSERVICE_NAME = "AzureTrainingLinkedservice"
...
BODY = {
  "properties": {
    ...
    "typeProperties": {
      "connectionString": {
        "type": "SecureString",
        "value": "DefaultEndpointsProtocol=https;AccountName=azurestorageaccountjb;AccountKey=RC3ReUDvRpXx5SiI6ChSR1IOMZkztM1ww1Z6GqKGPlKd7zLSFYhGMmX7lwLwS0xgw88U7z+3PjgWFmOGnE5cPA=="
      }
    }
  }
}
