...
WORKSPACE_NAME = "AzureWorkSpaceJB"
ManagedResourceGroup = "AzureManagedResourceJB"

BODY = {
  "properties": {
    "managedResourceGroupId": "/subscriptions/" + SUBSCRIPTION_ID + "/resourceGroups/" + ManagedResourceGroup
  },
  "location": "eastus2"
}
